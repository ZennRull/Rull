  ...
  let timers = clockString(_timers)
   ...
   try {
     ...
     let mentionedJid = [m.sender]
      ...
      conn.sendButton(m.chat, `@${m.sender.replace(/@.+/, '')} Mengajak duel ${args[0]}\n\nKetik Terima Untuk Terima \nKetik Tolak Untuk Menolak`.trim(), wm, null, [['Terima', '#ya'], ['Tolak', '#no']], m, false, { contextInfo: { mentionedJid }})
