...
let handler  = async (m, { conn, command, args, usedPrefix, owner }) => {
    ...
    let nomors = m.sender
    const Kchat = `
Penggunaan ${usedPrefix}shop2 <Buy|sell> <item> <jumlah>
Contoh penggunaan: *${usedPrefix}shop2 buy potion 1*

▬۪▭ׁ▬۪▭ׁ▬۪▭ׁ▬۪▭ׁ▬۪▭ׁ▬۪▭ׁ▬۪
...
handler.command = /^(shop2|toko2|buy2|beli2|sell2|jual2)$/i
